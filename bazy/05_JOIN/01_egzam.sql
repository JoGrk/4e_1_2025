...
FROM kursy  
    INNER JOIN kursy_uczestnicy ON kursy.kod = kursy_uczestnicy.kod_kursu
    INNER JOIN uczestnicy ON uczestnicy.id_uczestnika = kursy_uczestnicy.id_uczestnika;
...
SELECT abonamenty_id, cecha
FROM cechy
    INNER JOIN szczegolyabonamentu ON cechy.id = szczegolyabonamentu.abonamenty_id
ORDER BY cecha;
...
SELECT
    ...
    cecha
FROM abonamenty
    INNER JOIN szczegolyabonamentu 
    ON abonamenty.id = szczegolyabonamentu.abonamenty_id
    INNER JOIN cechy ON cechy.id = szczegolyabonamentu.cechy_id
